package com.selva.programs.graph2;
...
public class DepthFirstSearch_Iterative {
    ...
    public static void main(String[] args) {
        ...
        int root = 0;
        for(ArrayList list: adjLists){
        	Integer[] listArr = (Integer[]) list.toArray(new Integer[list.size()]);
        	System.out.println(root + ":- " + Arrays.toString(listArr));
        	root++;
        }
